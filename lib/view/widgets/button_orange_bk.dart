        ...
        child: TextButton(
          ...
          style: ButtonStyle(
            shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
              ...
              side: BorderSide(color: primaryColor, width: 2), // Đặt màu viền và độ rộng
            )),
          ...
          child: Container(
            child: Row(
              ...
              children: [
                (widget.icon == null) ? const SizedBox.shrink() : Icon(widget.icon ?? null, color: primaryColor),
                SizedBox(
                  width: 5,
                ),
                Text(widget.title ?? '', style: TextStyle(color: primaryColor, fontSize: 20)),
              ],
            ),
          ),
        ));
